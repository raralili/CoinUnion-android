...
class WritingViewModel @Inject constructor(private val writingDao: WritingDao) : ViewModel() {

    fun getListData(type: Int): Flowable<List<WritingInfo>> {
...
//            }
//        }
        return writingDao.loadAll().subscribeOn(Schedulers.io())
